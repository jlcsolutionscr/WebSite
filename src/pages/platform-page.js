...
function PlatformPage() {
  ...
  return (
    <div id='id_platform_page' className={classes.container}>
      ...
      <Typography className={classes.subTitle} paragraph>
        Opción 1: Utilice nuestro buzón recepcion@jlcsolutionscr.com para el registro de sus facturas y notas de crédito de gastos que posean impuesto de valor agregado (IVA) acreditable mensualmente.
      </Typography>
      <Typography className={classes.subTitle} paragraph>
        Opción 2: Utilice nuestro buzón recepciongasto@jlcsolutionscr.com para el registro de sus facturas y notas de crédito de gastos que NO poseen impuesto de valor agregado (IVA) acreditable mensualmente, sino que dichos impuestos serán reconocidos como parte de sus gastos fiscales del período en curso.
      </Typography>
      <Typography className={classes.subTitle} paragraph>
