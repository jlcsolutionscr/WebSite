  ...
  return (
    <div id="id_platform_page" className={classes.container}>
      ...
      <Typography className={[classes.paragraph, classes.margin5]} paragraph>
        El presente Política de Privacidad establece los términos en que JLC
        Solutions CR usa y protege la información que es proporcionada por sus
      ...
      <Typography className={[classes.paragraph, classes.margin5]} paragraph>
        JLC Solutions CR está altamente comprometido para cumplir con el
      ...
      <Typography className={[classes.paragraph, classes.margin5]} paragraph>
        JLC Solutions CR Se reserva el derecho de cambiar los términos de la
